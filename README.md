...
**Telary UI Library** - это мощная и красивая библиотека для создания интерфейсов в Roblox, вдохновленная Rayfield. Библиотека предлагает современный дизайн, плавные анимации и простой в использовании API.

## 📥 Установка

```
-- Добавьте в начало вашего скрипта:
local TelaryUI = loadstring(game:HttpGet("https://raw.githubusercontent.com/your-repo/TelaryUI/main/TelaryUI.lua"))()

🏗️ Создание окна
Базовое окно

local Window = TelaryUI:CreateWindow({
...
local TelaryUI = loadstring(game:HttpGet("URL_БИБЛИОТЕКИ"))()
