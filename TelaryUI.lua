    ...
    function Window:CreateTab(Name, Icon)
        ...
        function Tab:CreateSection(Name, Description)
            ...
            function Section:CreateKeybind(Config)
                ...
                Keybind.Frame.Parent = self.Content
                ...
                table.insert(self.Elements, Keybind.Frame)
                self:UpdateSize()
            ...
            function Section:CreateColorPicker(Config)
                ...
                table.insert(self.Elements, ColorPicker.Frame)
                self:UpdateSize()
            ...
            function Section:CreateProgressButton(Config)
                ...
                ProgressButton.Frame.Parent = self.Content
                ...
                table.insert(self.Elements, ProgressButton.Frame)
                self:UpdateSize()
            ...
            function Section:CreateCounterButton(Config)
                ...
                CounterButton.Frame.Parent = self.Content
                ...
                table.insert(self.Elements, CounterButton.Frame)
                self:UpdateSize()
